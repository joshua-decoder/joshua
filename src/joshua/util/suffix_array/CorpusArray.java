 ...
 * maintains a seperate int[] array that lists the start index for
...
//===============================================================
	...
	public int getSentenceIndex(int position) {
		...
		// for is the first word of a sentence. we return the
		// exact value.
		if (index >= 0) {
				return index;
		} else {
	 ...
	 * 
	 * @param position1           the position in the corpus
	 *                            where the first suffix begins
	 * @param position2           the position in the corpus
	 *                            where the second suffix begins
