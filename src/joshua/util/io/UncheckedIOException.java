...
/**
 * This class provides an unchecked version of IOException. It is generally preferable to use
 * IOException directly, but this class can be useful in contexts where an interface does not allow
 * one to throw checked exceptions.
 * 
...
public class UncheckedIOException extends RuntimeException {
  ...
  public void setStackTrace(StackTraceElement[] stackTrace) throws NullPointerException {
