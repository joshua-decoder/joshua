...
//===============================================================
	...
	/**
	 * characters defined as spaces for the purpose of tokenizing Strings
	 */
...
//===============================================================
	...
	/**
	 * creates a new phrase, allocating a specific amount of memory for the eventual size of this Phrase.
	...
	/**
	 * Contstructor takes in a String phrase. It is tokenized on the space
	 * character and Word objects are made from the tokens, then placed in the 
	 * ArrayList.
	...
	/**
	 * Creates a phrase from an existing phrase. This does not copy the underlying
	 * words.
...
//===============================================================
	...
	/**
	 * @resuts the vocabulary that the words in this phrase are drawn from.
	 */
	...
	/**
	 * @return the index of the first occurrence of the subphrase after the specified index,
	 * if the subphrase is present, or -1 if it is not.
	 */
	public int indexOf(Phrase subPhrase, int startFrom) {
		if(subPhrase.size() == 0) return -1;
	...
	/**
	 * uses comparisons of component words. Same as comparing the
	 * string results of Phrase.toString();
