...
public class ClassifierSVM implements ClassifierInterface 
{
	...
	@Override
	/* for LibSVM:
	 * param[0] = LibSVM command file path
	 * param[1] = LibSVM training data file(generated on the fly) path
	 * param[2] = LibSVM model file(generated after training) path
	 * note: the training file path should be consistent with the one specified in command file
	 */
