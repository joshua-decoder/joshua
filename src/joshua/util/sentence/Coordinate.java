...
public class Coordinate implements Comparable {
	...
	/**
	 * This constructor creates a duplicate of the coordinate
	 * passed to it.
	 * 
	 ...
	 * transpose objects within Sets, we need their hashcode to
	 * stay the same after transposition. To do this, we take the
	 * smaller of x or y and multiply it by 100, then add it to
	 * the larger value. This is used as opposed to a more complex
	 * and unique calculation since most coordinates we will work
	 * with will be less than 100.
	 * 
	...
	/**
	 * Static method to create a coordinate from a String in
	 * the format "X.Y", or in the format "X-Y"
	 * 
