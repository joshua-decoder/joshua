 ...
 * 
 */
package joshua.training.risk_annealer.hypergraph.parallel;

import java.util.HashMap;
import java.util.Map;
import java.util.concurrent.BlockingQueue;

import joshua.semiring_parsing.MinRiskDAFuncValSemiringParser;
import joshua.semiring_parsing.MinRiskDAGradientSemiringParser;
import joshua.semiring_parsingv2.applications.min_risk_da.MinRiskDADenseFeaturesSemiringParser;
import joshua.training.parallel.Consumer;
import joshua.training.risk_annealer.hypergraph.FeatureForest;
import joshua.training.risk_annealer.hypergraph.HGAndReferences;
import joshua.training.risk_annealer.hypergraph.HGRiskGradientComputer;
import joshua.training.risk_annealer.hypergraph.RiskAndFeatureAnnotationOnLMHG;
