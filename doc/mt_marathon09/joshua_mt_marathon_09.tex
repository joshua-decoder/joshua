...
\title{Joshua: an Open-source Decoder for Parsing-based Machine Translation}

%%% the order and names may change
\author{%
Zhifei Li,\,\,\,
Chris Callison-Burch,\,\,\,
Wren N.\,G.\,Thornton,\,\,\,
{\textnormal{ and}}\,\,\,Sanjeev Khudanpur\\
Department of Computer Science and Center for Language and Speech Processing\\
Johns Hopkins University, Baltimore, MD 21218, USA\\
{\{\tt zli19, callison-burch, winterkoninkje, khudanpur\}@jhu.edu}}
...
Large-scale parsing-based statistical machine translation (MT) has made remarkable progress in the last few years. The systems being developed differ in whether they use source- or target-language syntax.
