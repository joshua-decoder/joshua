...
/**
 * A class that listens for clicking on menu items to choose any of the three types of file for the
 * derivation browser: source file, reference file, or n-best file. After choosing a file from a
 * presented chooser box, this class updates the browser's translation info with the new file.
 * 
...
class FileChoiceListener implements ActionListener {
  ...
  /**
   * The constructor. Also automatically registers <code>this</code> as an action listener for each
   * button.
   * 
   ...
   */
  public FileChoiceListener(JFrame enclosingFrame, JMenuItem source, JMenuItem reference,
      JMenuItem nBest) {
  ...
  public void actionPerformed(ActionEvent e) {
    if (fileChooser.showOpenDialog(enclosingFrame) == JFileChooser.APPROVE_OPTION) {
      ...
      try {
        ...
        JOptionPane.showMessageDialog(enclosingFrame,
            "An I/O exception occurred: " + ioe.getMessage(), "IOException",
