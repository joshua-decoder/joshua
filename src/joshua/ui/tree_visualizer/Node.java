...
public class Node {
  ...
  /**
   * If this node is a node holding terminal symbols, a pointer to the node that represents symbols
   * that have been aligned with it.
   */
   ...
   * 
   * @param name a <code>String</code> that represents the symbols at this node
  ...
  /**
   * Returns a string representation of this node. That is, it returns the name of a non-terminal,
   * or terminals that have been joined with spaces.
   * 
   ...
   * 
   * @return true if the node is part of a source-side tree, false otherwise
   */
  ...
  /**
   * Returns an index into the source sentence that is one later than the last word that is aligned
   * with this node.
   * 
   * @return one plus the index of the last source word aligned with this node
   */
  ...
  /**
   * Returns the complete source phrase that is aligned with this node. We join together all the
   * source words from start to end using one space per join.
   * 
   * @param src the source sentence
   * 
   * @return a substring of the source sentence that is aligned with this node
   */
