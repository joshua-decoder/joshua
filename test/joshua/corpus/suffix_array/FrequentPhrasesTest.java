...
//	FrequentPhrases frequentToBePhrases;
...
//	}
	...
	public void longestCommonPrefix() {
		...
		try {
			...
			logger.fine("Constructing corpus array from file " + corpusFileName);
			corpusToBe = SuffixArrayFactory.createCorpusArray(corpusFileName, symbolTable, lengths[0], lengths[1]);
	...
	public void simplePhrases() {
		...
		for (Map.Entry<Phrase,Integer> entry : phrases.entrySet()) {
