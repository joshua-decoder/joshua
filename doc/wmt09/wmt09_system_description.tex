...
To tune the system parameters we used News Test Set from WMT08 \cite{Callison-Burch2008a}, which consists of 2,051 sentence pairs with 43 thousand English words and 46 thousand French words.  This is in-domain data that was gatered from the same news sources as the WMT09 test set.
